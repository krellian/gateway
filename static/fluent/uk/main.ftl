...
tunnel-setup-agree-privacy-policy = Погодьтеся з <a data-l10n-name="tunnel-setup-privacy-policy-link">Політикою приватності</a> та <a data-l10n-name="tunnel-setup-tos-link">Умовами надання послуг</a> WebThings.
